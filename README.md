...
2. Download the latest version of the mod in the [releases](https://github.com/RandomGuyJCI/UnityCtrlBackspace/releases/latest) page. It should be named `UnityCtrlBackspace_1.x.x.dll`.
3. Move the file into your `BepInEx/plugins` folder.
